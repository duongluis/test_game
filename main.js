...
var enemy = [
    new Character(Math.floor(Math.random() * (width-50)+50),getRandomIntInclusive(0,height-10),10,10,'black',5),
new Character(Math.floor(Math.random() * (width-50)+50),getRandomIntInclusive(0,height-10),10,10,'black',4),
new Character(Math.floor(Math.random() * (width-50)+50),getRandomIntInclusive(0,height-10),10,10,'black',5),
new Character(Math.floor(Math.random() * (width-50)+50),getRandomIntInclusive(0,height-10),10,10,'black',4),
new Character(Math.floor(Math.random() * (width-50)+50),getRandomIntInclusive(0,height-10),10,10,'black',4),
new Character(Math.floor(Math.random() * (width-50)+50),getRandomIntInclusive(0,height-10),10,10,'black',4),
...
new Character(Math.floor(Math.random() * (width-50)+50),getRandomIntInclusive(0,height-10),10,10,'black',5),
new Character(Math.floor(Math.random() * (width-50)+50),getRandomIntInclusive(0,height-10),10,10,'black',5),
new Character(Math.floor(Math.random() * (width-50)+50),getRandomIntInclusive(0,height-10),10,10,'black',6),
